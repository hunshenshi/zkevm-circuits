...
//     plonk::{Advice, Column, ConstraintSystem, Error, Expression, VirtualCells, Fixed, Instance},
//     poly::Rotation,
// };
...
//                     region.assign_advice_from_constant(|| "zero", chip.config.a, 0, || self.zero)?;
...
//         ($a:expr, $b:expr, $c:expr, $is_ok_or_err:ident) => {
